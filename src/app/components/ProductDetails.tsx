...
export default function ProductDetails({ params }: ProductDetailsProps) {
  const product = fashionProducts.find((p) => p.id.toString() === params.productId);
      ...
      <div className="w-4/5 mx-auto grid md:grid-cols-2 gap-32 items-start pt-8 mt-16">
        ...
        <div className="flex flex-col gap-6">
          ...
          <div className="mt-8 border-t pt-6">
            ...
            <p className="text-sm text-gray-600">Enjoy fast and secure delivery within 3–5 business days.</p>
          </div>
