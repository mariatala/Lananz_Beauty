...
const SectionDividerOne: React.FC = () => {
	return (
		<div className="w-full flex bg-[#F8EFE4] flex-col items-center justify-center h-fit mx-auto py-16 my-16 ">
			{/* Divider line */}
			<h2 className={`w-5/6  text-lg md:text-3xl text-center mb-4 rounded-full ${poppins.className} text-neutral-700 font-light tracking-wide`}>
